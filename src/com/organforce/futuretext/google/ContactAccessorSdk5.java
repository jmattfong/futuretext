...
package com.organforce.futuretext.google;
...
public class ContactAccessorSdk5 extends ContactAccessor {
    ...
    public ContactInfo loadContact(ContentResolver contentResolver, Uri contactUri) {
        ...
        ContactInfo c2 = loadContact(contentResolver, contactId);
        
        contactInfo.setPhoneNumber(c2.getPhoneNumber());

        return contactInfo;
    }

	@Override
	public ContactInfo loadContact(ContentResolver contentResolver, long contactId) {
		ContactInfo contactInfo = new ContactInfo();
    ...
    public String[] from() {
    	return new String[]{Contacts._ID, Contacts.DISPLAY_NAME};
    }

	@Override
	public Cursor fetchAllContacts(ContentResolver contentResolver) {
		return contentResolver.query(Contacts.CONTENT_URI, from(),
				null, null, null);
	}
}