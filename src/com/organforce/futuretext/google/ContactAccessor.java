...
public abstract class ContactAccessor {
    ...
    public static ContactAccessor getInstance() {
        if (sInstance == null) {
            ...
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                className = "com.TextTimer.google.ContactAccessorSdk3_4";
            } else {
                className = "com.TextTimer.google.ContactAccessorSdk5";
            }
    ...
    public abstract ContactInfo loadContact(ContentResolver contentResolver, long contactId);
    
    public abstract String[] from();
    
    public abstract Cursor fetchAllContacts(ContentResolver contentResolver);
}